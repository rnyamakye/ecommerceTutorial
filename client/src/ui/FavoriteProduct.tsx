  ...
  return (
    <div className="flex py-6">
      <div className="min-w-0 flex-1 lg:flex lg:flex-col">
        <div className="lg:flex-1">
          ...
          <div className="flex text-sm items-center gap-6 font-medium py-4">
            <AddToCartButton product={product} className="w-32 " />
          </div>
        </div>
        <p>
          You are saving{" "}
      ...
      <div
        ...
        className="ml-4 flex-shrink-0 h-20 w-20 sm:h-40 sm:w-40 sm:order-first sm:m-0 sm:mr-6 border border-gray-200 rounded-md hover:border-skyText duration-200 cursor-pointer group overflow-hidden"
      >
        <img
